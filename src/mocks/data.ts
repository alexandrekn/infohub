import type { Anotacao, Curso, Entregavel, Equipe, Etapa, HistoricoEtapa, Lembrete, Tarefa, Usuario } from "@/types";
...
export const USUARIOS: Usuario[] = [
  { id_usuario: 1, nome: "Bruna Nunes", telefone: "55999990001", email: "bruna.admin@infohub.edu.br", perfil: "admin", ativo: true },
  { id_usuario: 2, nome: "Rafael Costa", telefone: "55999990002", email: "rafael.mentor@infohub.edu.br", perfil: "mentor", ativo: true },
  { id_usuario: 3, nome: "Camila Fagundes", telefone: "55999990003", email: "camila.mentor@infohub.edu.br", perfil: "mentor", ativo: true },
  { id_usuario: 4, nome: "Gustavo Martins", telefone: "55999990004", email: "gustavo@aluno.edu.br", perfil: "aluno", id_curso: 1, semestre: 5, ativo: true },
  { id_usuario: 5, nome: "Larissa Prado", telefone: "55999990005", email: "larissa@aluno.edu.br", perfil: "aluno", id_curso: 1, semestre: 5, ativo: true },
  { id_usuario: 6, nome: "Diego Almeida", telefone: "55999990006", email: "diego@aluno.edu.br", perfil: "aluno", id_curso: 3, semestre: 3, ativo: true },
  { id_usuario: 7, nome: "Fernanda Reis", telefone: "55999990007", email: "fernanda@aluno.edu.br", perfil: "aluno", id_curso: 4, semestre: 7, ativo: true },
  { id_usuario: 8, nome: "Otávio Lima", telefone: "55999990008", email: "otavio@aluno.edu.br", perfil: "aluno", id_curso: 6, semestre: 2, ativo: true },
];
...
export const EQUIPES: Equipe[] = [
  {
    ...
    turma: "2026/1",
    integrantes: [
      { id_equipe_usuario: 1, id_equipe: 1, id_usuario: 4, papel: "lider", usuario: USUARIOS[3] },
      { id_equipe_usuario: 2, id_equipe: 1, id_usuario: 5, papel: "integrante", usuario: USUARIOS[4] },
    ],
  },
  {
    id_equipe: 2,
    ...
    turma: "2026/1",
    integrantes: [
      { id_equipe_usuario: 3, id_equipe: 2, id_usuario: 6, papel: "lider", usuario: USUARIOS[5] },
    ],
  },
  {
    id_equipe: 3,
    ...
    turma: "2025/2",
    integrantes: [
      { id_equipe_usuario: 4, id_equipe: 3, id_usuario: 7, papel: "lider", usuario: USUARIOS[6] },
    ],
  },
  {
    id_equipe: 4,
    ...
    turma: "2026/1",
    integrantes: [
      { id_equipe_usuario: 5, id_equipe: 4, id_usuario: 8, papel: "lider", usuario: USUARIOS[7] },
    ],
  },
];
...
/** Credenciais de teste — qualquer senha com 6+ caracteres funciona no mock. */
export const CREDENCIAIS_MOCK = USUARIOS.map((u) => u.email);
...
export const HISTORICO_ETAPAS: HistoricoEtapa[] = [
